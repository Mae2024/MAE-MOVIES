...
public class PlataformasController : Controller
{
    ...
    public PlataformasController(MovieDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> Create([Bind("Id,Nombre,Url,LogoUrl,PeliculaPlataforma")] Plataforma plataforma)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("Id,Nombre,Url,LogoUrl,PeliculaPlataforma")] Plataforma plataforma)
    {
        if (id != plataforma.Id)
        {
            return NotFound();
