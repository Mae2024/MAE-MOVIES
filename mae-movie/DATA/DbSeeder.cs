...
namespace mae_movie.DATA
{
            ...
            var peliculas = new List<Pelicula>
    {
        ...
        new Pelicula {
            ...
            MinutosDuracion = 209,
            PosterUrl = "https://m.media-amazon.com/images/M/MV5BYjRiMzYyNjItZmMwMy00ZGIwLWE2NDktMjcxYTM3MTE2ODhhXkEyXkFqcGc@._V1_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 124,
            PosterUrl = "https://m.media-amazon.com/images/M/MV5BMjAzMTI1MjMyN15BMl5BanBnXkFtZTgwNzU5MTE2NjM@._V1_FMjpg_UX1000_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 129,
            PosterUrl = "https://mx.web.img2.acsta.net/pictures/22/07/18/22/06/0534391.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 106,
            PosterUrl = "https://es.web.img3.acsta.net/pictures/22/03/01/15/19/5343614.jpg",
            Genero = g["Ciencia Ficción"], Plataforma = p["Netflix"]
        },
        new Pelicula {
            ...
            MinutosDuracion = 117,
            PosterUrl = "https://es.web.img2.acsta.net/pictures/22/10/19/12/15/3740227.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 120,
            PosterUrl = "https://upload.wikimedia.org/wikipedia/en/1/11/Sound_of_Metal_poster.jpeg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 114,
            PosterUrl = "https://upload.wikimedia.org/wikipedia/en/8/87/One_Night_in_Miami_poster.jpeg",
            Genero = g["Drama"], Plataforma = p["Prime Video"]
        },
        new Pelicula {
            Titulo = "Air",
            ...
            MinutosDuracion = 112,
            PosterUrl = "https://upload.wikimedia.org/wikipedia/en/d/de/AirFilmPoster.png",
            Genero = g["Drama"], Plataforma = p["Prime Video"]
        },
        new Pelicula {
            ...
            MinutosDuracion = 137,
            PosterUrl = "https://upload.wikimedia.org/wikipedia/en/d/de/Manchester_by_the_Sea.jpg",
            Genero = g["Drama"], Plataforma = p["Prime Video"]
        },
        ...
        new Pelicula {
            ...
            MinutosDuracion = 104,
            PosterUrl = "https://upload.wikimedia.org/wikipedia/en/f/f4/Hocus_Pocus_2_Logo.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 119,
            PosterUrl = "https://upload.wikimedia.org/wikipedia/en/9/93/Disenchanted.jpg",
            Genero = g["Comedia"], Plataforma = p["Disney+"]
        },
        ...
        new Pelicula {
            ...
            MinutosDuracion = 242,
            PosterUrl = "https://m.media-amazon.com/images/M/MV5BNDA0MzM5YTctZTU2My00NGQ5LWE2NTEtNDM0MjZmMDBkOTZkXkEyXkFqcGc@._V1_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 115,
            PosterUrl = "https://m.media-amazon.com/images/M/MV5BODRhMzgyOWMtNzRhNS00YTkwLWJiMDgtYjQzZWQ3MTA3NmUwXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 104,
            PosterUrl = "https://m.media-amazon.com/images/M/MV5BMTIyMjc0MzQtMTdiZi00YzE4LWJhNGMtMWIwYjM5Yzc1ZGM3XkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg",
        ...
        new Pelicula {
            ...
            MinutosDuracion = 92,
            PosterUrl = "https://m.media-amazon.com/images/M/MV5BMzRmN2Q2NmYtODAxMi00OGZmLWIyODAtMjU0ZDVmNGNiY2EyXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg",
            Genero = g["Drama"], Plataforma = p["Max"]
        },
        new Pelicula {
            ...
            MinutosDuracion = 106,
            PosterUrl = "https://m.media-amazon.com/images/M/MV5BYTNkOGQ4YmUtZGI1MS00N2EzLTkxMzMtMDk2ZTg0OTkyNWEwXkEyXkFqcGc@._V1_.jpg",
            Genero = g["Comedia"], Plataforma = p["Max"]
        }
    };
